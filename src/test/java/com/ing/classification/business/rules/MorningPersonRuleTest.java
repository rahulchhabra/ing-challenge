...
public class MorningPersonRuleTest {
    ...
    public void isApplicable_false() {
        ...
        assertEquals(false, morningPersonRule.isApplicable(resultBuilder));
    }
    ...
    public void isApplicable_true() {
        ...
        resultBuilder.addTransactions(tList);
        assertEquals(true, morningPersonRule.isApplicable(resultBuilder));
    }
}